...
<%
	...
	Product product1 = new Product("P0001", "콜라", 3000, 1, "/img/coke.jpg");
	Product product2 = new Product("P0002", "스프라이트", 3000, 1, "/img/sprite.jpg");
	Product product3 = new Product("P0003", "소주", 5000, 1, "/img/soju.jpg");
	Product product4 = new Product("P0004", "맥주", 5000, 1, "/img/cass.jpg");
