...
<%
	...
	Product product1 = new Product("P0001", "만두", 6000, 1, "/img/dumpling.jpg");
	Product product2 = new Product("P0002", "돈까스", 9000, 1, "/img/cutlet.jpg");
	Product product3 = new Product("P0003", "새우튀김", 5000, 1, "/img/fried_shrimp.jpg");
